...
class Ui_DeleteWindow(object):
    ...
    def setupUi(self, DeleteWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/pycharm.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonBox.accepted.connect(DeleteWindow.respondYes)
        self.buttonBox.rejected.connect(DeleteWindow.respondNo)
